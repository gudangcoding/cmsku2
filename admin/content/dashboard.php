...
<div class="row">
	<div class="col-md-6">
		<?php
			//Membuat fungsi dapatkan nilai untuk membaca pengaturan website 
			...
			//Menentukan tampilan homepage sesuai nilai parameter homepage
		...
		<table class="table table-striped">
			<thead>
				<tr>
					<th colspan="2"><h3><b>Identitas Website</b></h3>
				</tr>
			</thead>
			<tbody>
				<tr>
					<td><b>Judul Website</b></td>
					<td>: <?= dapatkan_nilai("judul"); ?></td>
				</tr>
				<tr>
					<td><b>URL Website</b></td>		
					<td>: <?=  dapatkan_nilai("url"); ?></td>
				</tr>
				<tr>
					<td><b>Folder</b></td>			
					<td>: <?=  dapatkan_nilai("folder"); ?></td>
				</tr>
				<tr>
					<td><b>Ikon</b></td>			
					<td>: <img src="../media/thumbs/<?=  dapatkan_nilai("ikon"); ?>" width="60"></td>
				</tr>
				<tr>
					<td><b>Keyword</b></td>			
					<td>: <?=  dapatkan_nilai("keyword"); ?></td>
				</tr>
				<tr>
					<td><b>Homepage</b></td>		
					<td>: <?=  $str_homepage; ?></td>
	...
	<div class="col-md-6">			
		<table class="table table-striped">
			<thead>
				<tr>
					<th colspan="2"><h3><b>Komentar Terbaru</b></h3></th>
				</tr>
			</thead>
			<tbody>
				<?php
